...
__decorate([
    typeorm_1.ManyToOne(() => permission_entity_1.Permission, (permission) => permission.rolePermissions, {
        nullable: false,
        eager: true,
    }),
...
__decorate([
    typeorm_1.ManyToOne(() => role_entity_1.Role, (role) => role.rolePermissions, {
        nullable: false,
    }),
