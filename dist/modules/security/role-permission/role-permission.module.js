...
const role_permission_repository_1 = require("./repository/role-permission.repository");
let RolePermissionModule = class RolePermissionModule {
};
RolePermissionModule = __decorate([
    common_1.Module({
        imports: [typeorm_1.TypeOrmModule.forFeature([role_permission_repository_1.RolePermissionRepository])],
        controllers: [],
        providers: [],
    })
